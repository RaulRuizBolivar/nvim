...
return {
  {
    ...
    opts = {
      ...
      workspaces = {
        {
          name = "RaulRuizBolivar", -- Name of the workspace
          path = "/Users/raulruizbolivar/Documents/Obsidian/", -- Path to the notes directory
        },
      },
      ...
      notes_subdir = "NotasTrabajo", -- Subdirectory for notes
      new_notes_location = "NotasTrabajo", -- Location for new notes
